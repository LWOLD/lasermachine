...
// Internal Types
//
typedef std::auto_ptr<v4_Printer_Driver1_Render_Filter::PrintTicketHandler>         PrintTicketHandler_t;
typedef std::auto_ptr<SafeHGlobal>                              SafeHGlobal_t;
typedef std::auto_ptr<SafeHPTProvider>                          SafeHPTProvider_t;
typedef CComPtr<v4_Printer_Driver1_Render_Filter::FilterLiveness>                   FilterLiveness_t;
