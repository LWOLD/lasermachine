...
//
class __declspec(uuid("71697c67-947f-4199-a694-05c1cc67f3d2")) RenderFilterFactory : public UnknownBase<IClassFactory>
{
public:
    RenderFilterFactory() :
        m_serverLocks(0)
        ...
        )
    {
        ...
        *ppvObject = NULL;
        ...
        v4_Printer_Driver1_Render_Filter::RenderFilter *pFilter = NULL;
        ...
        try
        {
            ...
            pFilter = new v4_Printer_Driver1_Render_Filter::RenderFilter();
        }
        CATCH_VARIOUS(hr)
    ...
    )
{
    ...
    *ppv = NULL;
    ...
    if (rclsid != __uuidof(v4_Printer_Driver1_Render_Filter::RenderFilterFactory))
    {
    ...
    v4_Printer_Driver1_Render_Filter::RenderFilterFactory *pFactory = NULL;
    pFactory = new(std::nothrow) v4_Printer_Driver1_Render_Filter::RenderFilterFactory();
...
DllCanUnloadNow()
{
    return (0 == v4_Printer_Driver1_Render_Filter::RenderFilter::ms_numObjects) ? S_OK : S_FALSE;
}
    ...
    )
{
    ...
    case DLL_PROCESS_ATTACH:
        ...
        WPP_INIT_TRACING(L"v4PrinterDriver1RenderFilter");
